					...
					<div class="container">
						...
						<div class="topbar-menu right-menu">
							<ul>
                               ...
                               <li class="menu-item menu-item-has-children parent" >
									<a title="Dollar (USD)" href="#">My Account ({{Auth::user()->FirstName}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
									<ul class="submenu curency" >
										<li class="menu-item" >
											<a title="Pound (GBP)" href="{{route('admin.dashboard')}}">Admin Dashboard</a>
										</li>
										<li class="menu-item" >
                               ...
                               @else
                                 ...
                                 <li class="menu-item menu-item-has-children parent" >
									...
									<ul class="submenu curency" >
										...
										<li class="menu-item" >
											<a title="Pound (GBP)" href="{{route('user.orders')}}">My Orders</a>
										</li>


										<li class="menu-item" >
											<a title="Pound (GBP)" href="{{route('user.profile')}}">My Profile</a>
										</li>

										<li class="menu-item" >
											<a title="Pound (GBP)" href="{{route('user.changepassword')}}">Change Password</a>
										</li>
										<li class="menu-item" >
											<a title="logout" href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
										</li>
