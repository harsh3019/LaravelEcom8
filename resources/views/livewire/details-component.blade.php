				...
				<div class="wrap-product-detail">
						...
						<div class="product-gallery" wire:ignore>
						  <ul class="slides">
							...
							<li data-thumb="{{asset('assets/images/products')}}/{{$product->image}}">
								<img src="{{asset('assets/images/products')}}/{{$product->image}}" alt="{{$product->name}}" alt="product thumbnail" />
							</li>
							@php
					...
					<div class="detail-info">
						<div class="product-rating">
							...
							@endif
							@endfor --}}
							{{-- <a href="#" class="count-review">({{$product->orderItems->where('rstatus',1)->count()}})</a> --}}
						</div>
							...
							<li class="product-item">
								<div class="product product-widget-style">
									...
									<div class="product-info">
										<a href="{{route('product.details',['slug'=>$p_product->slug])}}" class="product-name">
											<span>{{$p_product->name}}</span></a>
						...
						<div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
							...
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									...
									<div class="wrap-price"><ins><p class="product-price">&#8377;{{$r_product->regular_price}}</p></ins> <del><p class="product-price">&#8377;250.00</p></del></div>
									</div>
								</div>
								@endforeach
