            ...
            <div class=" main-content-area">
                    ...
                    <ul class="products-cart">
                        ...
                        <li class="pr-cart-item">
                            ...
                            @foreach ($item->options as $key=>$value)
                                <div class="vertical-align:middle; width:180px">
                                    <p><b>{{$key}}: {{$value}}</b></p>
                                </div>
                            @endforeach
                            ...
                            <div class="delete">
                                <a href="#" class="btn btn-delete" title="" wire:click.prevent="destory('{{$item->rowId}}')">
              ...
              <div class="summary">
                    <div class="order-summary">
                        ...
                        <a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i></a></span><b class="index">{{$discount}}</b></p>
