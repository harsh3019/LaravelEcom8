                                ...
                                <div class="product product-style-3 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-wish">
                                            ...
                                            <a href="#" wire:click.prevent="removeFromWishlist({{$product->id}})"><i class="fa fa-heart fill-heart"></i>
                                            @else
                                             <a href="#" wire:click.prevent="addToWishList({{$product->id}},'{{$product->name}}',{{$product->regular_price}})"><i class="fa fa-heart"></i>
                                                @endif
                                        </div>
                                    </div>
                                </div>
                ...
                @if(count($category->subCategories) > 0)
                  <span class="toggle-control">+</span>
                   ...
                   @foreach ($category->subCategories as $scategory)
                     ...
                     <a href="{{route('product.category',['category_slug'=>$category->slug,'scategory_slug'=>$scategory->slug])}}" class="cat-link"><i class="fa fa-caret-right"></i> {{$scategory->name}}</a></li>   
                     @endforeach
                            </ul>
                            @endif
                                </li>
