            ...
            <div class=" main-content-area">
                        ...
                        <div class="biling-address">
                          ...
                          <input  type="text" name="add" value="" placeholder="Street at apartment number" wire:model="line2">
                            ...
                            <p class="row-in-form">
                                ...
                                <input  type="text" name="country" value="" placeholder="Enter Country" wire:model="country">
                                @error('country') <span class="text-danger">{{$message}}</span> @enderror
                            </p>
                            
                             <p class="row-in-form">
                                <label for="zip-code">Province:</label>
                                <input  type="text" name="province" value="" placeholder="Enter Province" wire:model="province">
                      ...
                      <div class="wrap-address-billing">
                        ...
                        <div class="biling-address">
                          ...
                          <input  type="text" name="add" value="" placeholder="Street at apartment number" wire:model="s_line2">
                            ...
                            <p class="row-in-form">
                                <label for="country">Country<span>*</span></label>
                                <input  type="text" name="country" value="" placeholder="Enter Country" wire:model="s_country">
                             ...
                             <p class="row-in-form">
                                <label for="zip-code">Province:</label>
                                <input  type="text" name="province" value="" placeholder="Enter Province" wire:model="s_province">
                ...
                <div class="summary summary-checkout">
                    <div class="summary-item payment-method">
                        ...
                        <div class="wrap-address-billing">
                            ...
                            @endif
                             <p class="row-in-form">
                                ...
                                <input  type="text" name="card-no" value="" placeholder="Enter Card Number" wire:model="card_no">
                             ...
                             <p class="row-in-form">
                                ...
                                <input  type="password" name="card-no" value="" placeholder="Enter CVC" wire:model="cvc">
                        ...
                        <p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price">   
                        &#8377;{{Session::get('checkout')['total']}}</span></p>
                        @endif
           
              @if($errors->isEmpty())            
     <div wire:ignore id="processing" style="font-size:22px; margin-bottom:20px;padding-left:37px;color:green;display: none;">
             <i class="fa fa-spinner fa-plus fa-fw"></i>
