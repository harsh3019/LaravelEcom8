...
class UserDashboardComponent extends Component
{
    public function render()
    {
        ...
        return view('livewire.user.user-dashboard-component',['orders'=>$orders,'totalCost'=>$totalCost,'totalPurchase'=>$totalPurchase,
        'totalDelivered'=>$totalDelivered,'totalCancelled'=>$totalCancelled])->layout('layouts.base');
    }
}
